...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(3,3,3,96, 'single'), zeros(1, 96, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 1,...
...
% 17 conv1
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(3,3,192,384, 'single'), zeros(1, 384, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 1,...
...
% 19 conv1
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(1,1,384,384, 'single'), zeros(1, 384, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 0,...
...
% 21 conv1
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(1,1,384,100, 'single'), zeros(1, 100, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 0,...
